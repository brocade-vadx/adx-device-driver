...
def main(argv=sys.argv[1:]):
    ...
    devices_file_name = unicode('/etc/neutron/services/'
                                'loadbalancer/brocade/device_inventory.ini')
    ...
    device_parser_create.add_argument('--management-ip',
                                      ...
                                      help='Management IP Address '
                                           'of the device')
    device_parser_create.add_argument('--user', dest='user',
                                      required=True,
                                      help='User Name')
    ...
    device_parser_create.add_argument('--name', dest='name',
    ...
    device_parser_create.add_argument('--nova-instance-id',
                                      ...
                                      help='nova instance id of the adx '
                                           '(if deployed in openstack)')
    device_parser_create.add_argument('--status',
                                      dest='status',
                                      default="active",
                                      required=False,
    ...
    port_parser_create.add_argument('--network-id',
                                    ...
                                    help='The network id to which the '
                                         'port is connected')
    port_parser_create.add_argument('--mac',
                                    dest='mac',
                                    required=False,
                                    help='mac address of the port')
    port_parser_create.set_defaults(func=create_port)

    device_parser_update.add_argument('--id',
                                      dest='id',
                                      required=True,
                                      help='id of the device')
    device_parser_update.add_argument('--user',
                                      dest='user',
                                      required=False,
                                      help='User Name')
    device_parser_update.add_argument('--password',
                                      dest='password',
                                      required=False,
                                      help='Password')
    device_parser_update.add_argument('--communication-type',
                                      ...
                                      required=False,
                                      help='HTTP/HTTPS')
    device_parser_update.add_argument('--name',
                                      dest='name',
                                      required=False,
                                      help='Device Name')
    device_parser_update.add_argument('--version',
                                      dest='version',
                                      required=False,
                                      help='running image version of the adx')
    ...
    device_parser_update.add_argument('--nova-instance-id',
                                      ...
                                      help='nova instance id of the adx '
                                           '(if deployed in openstack)')
    device_parser_update.add_argument('--status', dest='status',
                                      required=False,
                                      help='active, stopped, paused, '
                                           'suspended, error, inactive')
    ...
    device_parser_delete.add_argument('--id', dest='id',
                                      required=True, help='Device ID')
    device_parser_delete.set_defaults(func=delete_device)

    port_parser_delete.add_argument('--id', dest='id',
                                    required=True, help='id of the port')
